  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-950 dark:to-slate-900 transition-colors duration-300">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-200/50 dark:border-slate-800/50 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t border-slate-200 dark:border-slate-800">
            <div>
              ...
              <div className="text-xl font-bold text-slate-900 dark:text-white">{paper.year}</div>
            </div>
            <div>
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Citations</div>
              <div className="text-xl font-bold text-slate-900 dark:text-white">{paper.citationCount.toLocaleString()}</div>
            </div>
            {paper.journal && (
              <div className="col-span-2">
                <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Journal</div>
                <div className="text-lg font-semibold text-slate-900 dark:text-white">{paper.journal}</div>
              </div>
            )}
          </div>
        </div>
        ...
        {paper.abstract && (
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-200/50 dark:border-slate-800/50 mb-8">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Abstract</h2>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200/50 mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {paper.topics.map(topic => (
                <span
                  key={topic}
                  className="px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-xl text-sm font-medium hover:bg-blue-100 dark:hover:bg-blue-900/50 cursor-pointer transition-colors"
                >
                  {topic}
                </span>
              ))}
        ...
        {/* DOI & Links Section */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-sm border border-slate-200/50 dark:border-slate-800/50 mb-8">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">Access & Links</h2>
            ...
            {paper.doi && (
              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                <div>
                  ...
                  <code className="text-sm text-slate-700 dark:text-slate-300">{paper.doi}</code>
                </div>
                <a
            ...
            {paper.pdfUrl && (
              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                <div>
                  ...
                  <span className="text-sm text-slate-700 dark:text-slate-300">Full paper available</span>
                </div>
                <a
                  href={paper.pdfUrl}
                  target="_blank"
